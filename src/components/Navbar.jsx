...
export default function Navbar(){
  const [isNavbarOpen, setIsNavbarOpen] = useState(false)
    ...
    return (
      <nav className=" font-madimi-one flex max-md:flex-col max-md:items-center justify-between px-10 md:px-32 sticky w-full top-0 left-0 shadow-md bg-white backdrop-blur-md z-10">
        ...
        <div className={`${ isNavbarOpen ? 'top-[50px] ' : '-top-[500px] '} transition-all duration-500 ease-in-out absolute text-center w-full max-md:flex max-md:gap-4 max-md:flex-col max-md:py-5 bg-white/90 md:bg-transparent md:static md:flex md:items-center md:justify-end z-30`}>
